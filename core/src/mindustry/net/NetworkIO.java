...
public class NetworkIO{
    private static final int noServerVersionOverride = Integer.MIN_VALUE;
    private static volatile int serverVersionBuildOverride = noServerVersionOverride;
    private static volatile String serverVersionTypeOverride;

    /** Overrides only the version fields advertised in server-list pings. */
    public static void setServerVersionAdvertisement(int build, String versionType){
        serverVersionBuildOverride = build;
        serverVersionTypeOverride = versionType;
    }

    /** Restores the normal build metadata for server-list pings. */
    public static void clearServerVersionAdvertisement(){
        serverVersionBuildOverride = noServerVersionOverride;
        serverVersionTypeOverride = null;
    }
    ...
    public static ByteBuffer writeServerData(){
        ...
        int advertisedBuild = headless && serverVersionBuildOverride != noServerVersionOverride ? serverVersionBuildOverride : Version.build;
        String advertisedVersionType = headless && serverVersionTypeOverride != null ? serverVersionTypeOverride : Version.type;
        buffer.putInt(advertisedBuild);
        writeString(buffer, advertisedVersionType);
