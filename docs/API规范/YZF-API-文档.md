...
8. [JavaScript API 完整参考](#7-javascript-api-完整参考)
   ...
   - 7.22 [yzf.module 跨模块通信](#722-yzfmodule--跨模块通信)
    ...
    - 7.32 [yzf.metrics 服务监控与指标](#732-yzfmetrics--服务监控与指标)
    - 7.33 [yzf.compatibility 兼容性中间件](#733-yzfcompatibility--兼容性中间件)
    - 7.34 [yzf.process 进程运行时管理](#734-yzfprocess--进程运行时管理)
